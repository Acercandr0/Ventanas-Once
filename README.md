...
```
**Note:** My icons used for the Start Button are located in my C drive `C:\Customization\Icons\Start Button\`, but you can download them from the main branch or use your own custom path and buttons. There should be three versions: **Normal**, **Hover**, and **Pressed**.
